...
with col1:
    ...
    q0 = st.number_input("Kälteleistung [kW]", value=1.0) if show_q0 else 0.0
    qc = st.number_input("Wärmeleistung [kW]", value=1.0) if show_qc else 0.0
    vcom = st.number_input("Verdichtervolumenstrom [m3/h]", value=1.0) if show_vcom else 0.0
